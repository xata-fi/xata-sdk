...
export declare class HybridPool {
    ...
    getOutputAmount(inputAmount: CurrencyAmount<Token>): [CurrencyAmount<Token>, HybridPool];
    getInputAmount(outputAmount: CurrencyAmount<Token>): [CurrencyAmount<Token>, HybridPool];
