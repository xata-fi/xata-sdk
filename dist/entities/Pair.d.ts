...
export declare class Pair {
    ...
    static getAddress(tokenA: Token, tokenB: Token, isXataPair?: boolean, xataEnvIsProduction?: boolean | undefined): string;
    constructor(currencyAmountA: CurrencyAmount<Token>, currencyAmountB: CurrencyAmount<Token>, isXataPair?: boolean, xataEnvIsProduction?: boolean | undefined);
    /**
