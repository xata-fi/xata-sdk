...
export const FACTORY_ADDRESS: {[exchanger in Exchanger]: AddressMap} = {
  [Exchanger.SUSHI]: {
  ...
  [Exchanger.CONVEYOR]: {
    [ChainId.MAINNET]: '0xCB58e6ae0E4A8531c39093e52AbfbF5C94834516',
    // [ChainId.BSC]: '0x3818eAb6Ca8Bf427222bfACFA706c514145F4104',
    [ChainId.BSC]: '0xB889fb7fd2cf5F411522C97ef117D27974e1E182',
    [ChainId.MATIC]: '0xBAA526496e869636Af0B8B334ebee048a4a2941d'
  }
}
...
export const CONVEYOR_V2_ROUTER_ADDRESS: AddressMap = {
  [ChainId.MAINNET]: '0x631022af7769c462be54d535996e29b429d93512',
  // [ChainId.BSC]: '0x4A351C6aE3249499CBb50E8FE6566E2615386Da8',
  [ChainId.BSC]: '0xd40cB7a08B77e20B4A6860855CF8ad8D2Fe64813',
  [ChainId.MATIC]: '0x6aEBD85C4952A0c9f2CFDA34270e030dFC024A59'
}